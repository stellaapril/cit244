...
public class Crypt {
    ...
    public byte[] generateInitialKeyParis(){
        
    }
    
    
    //given a public key generated from scratch create a public key for a communication counterparty of the propery length and type 
    //
    public byte[] generateCounterpartyKeyPair(byte[] firstPubKey){
